            ...
            <Card className="p-8 text-center space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground max-w-sm mx-auto">
                  Fetch recent commits automatically with 1-click GitHub sync to synthesize your first multi-audience release note.
                </p>
              </div>
              <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
                ...
                <Link href="/projects/import">
                  <Button variant="outline" size="sm" className="gap-1.5 text-xs border-indigo-500/30 text-primary">
                    <GithubLogo className="h-3.5 w-3.5" weight="bold" /> Import Git Repo
                  </Button>
                </Link>
              </div>
            </Card>
